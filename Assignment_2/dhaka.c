...
void child(char c, FILE *file)
{
    ...
    if(c == 'A')
    {
        ...
        if (rc == 0)
        {
            execl("/bin/sh","sh","/home/kd/assignment2/bashscript.sh",NULL);
        }
        else if(rc < 0)
        {
    ...
    if(c == 'B')
    {
        ...
        if (rc == 0)
        {
            execl("/bin/sh","sh","/home/kd/assignment2/bashscript2.sh",NULL);
        } 
        else if(rc < 0)
        {
            fprintf(stderr, "fork failed\n");
    ...
    if(c == 'C')
    {
        ...
        if (rc == 0)
        {
            execl("/bin/sh","sh","/home/kd/assignment2/bashscript3.sh",NULL);
        }
        else if(rc < 0)
        {
            fprintf(stderr, "fork failed\n");
...
{
    FILE *fileOutput;
    fileOutput = fopen("/kd/assignment2/result.txt","w");
